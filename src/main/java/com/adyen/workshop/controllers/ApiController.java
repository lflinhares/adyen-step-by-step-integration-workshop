...
public class ApiController {
    ...
    public ResponseEntity<PaymentResponse> payments(@RequestBody PaymentRequest body) throws IOException, ApiException {
        ...
        paymentRequest.setReturnUrl("https://miniature-guide-xgpxv4q746jc6v47-8080.app.github.dev/handleShopperRedirect");
    ...
    public RedirectView redirect(@RequestParam(required = false) String payload,
        ...
        var redirectURL = "https://miniature-guide-xgpxv4q746jc6v47-8080.app.github.dev/result/"; // Update your url here by replacing `http://localhost:8080`
